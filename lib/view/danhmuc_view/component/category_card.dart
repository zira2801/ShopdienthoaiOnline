  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        ...
        child: CachedNetworkImage(imageUrl: baseUrl + widget.category.image,
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      ...
                      productController.searchEditController.text = 'category: ${widget.category.name}';
                      productController.searchVal.value = 'category: ${widget.category.name}';
